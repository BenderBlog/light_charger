/*
Login window of the watermeter_postgraduate program.
...
import 'package:watermeter_postgraduate/modified_library/sprt_sn_progress_dialog/sprt_sn_progress_dialog.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        children: [
          /// Temporary symbol of watermeter_postgraduate.
          const CircleAvatar(
            backgroundImage: AssetImage("assets/Login-Background.jpg"),
            radius: 60.0,
          ),
          const SizedBox(height: 15.0),
          const Text('请登录 watermeter_postgraduate',
              style: TextStyle(
