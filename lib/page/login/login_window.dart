...
import 'package:watermeter_postgraduate/page/login/app_icon.dart';
...
class _LoginWindowState extends State<LoginWindow> {
  ...
  Widget contentColumn() => Column(
        ...
        children: [
          ...
          FilledButton(
            ...
            onPressed: () async {
              if (_idsAccountController.text.length >= 8 &&
  ...
  void initState() {
    ...
    var cachedAccount = preference.user["idsAccount"] ?? "";
